function copyBibTeX() {
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const imageCarousel = new Carousel(
      document.querySelector("#PhanSeqCarousel"),
      5000
    );
    const videoCarousel = new Carousel(
      document.querySelector("#PhanVideosCarousel"),
      8000
    );
    const imageCarousel2 = new Carousel(
      document.querySelector("#ExVivoSeqCarousel"),
      5000
    );
    const videoCarousel2 = new Carousel(
      document.querySelector("#ExVivoVideosCarousel"),
      8000
    );

    // Add touch support
    const carousels = [imageCarousel, videoCarousel, imageCarousel2, videoCarousel2];
